...
public:
		...
		:m_Camera(45.0f, 0.1f, 100.0f)
	{
		...
		m_World.Add_Material(glm::vec3(0.2f, 0.3f, 1.0f), 1.0f, 1.0f);
		m_World.Add_Material(glm::vec3(1.0f, 1.0f, 1.0f), 1.0f, 1.0f);
	...
	virtual void OnUIRender() override
	{
		...
		for (int i = 0; i < m_World.Size(); i++) {
			...
			ImGui::ColorEdit3("Albedo", glm::value_ptr(m_World.materials[sphere.m_MaterialID].albedo), 0.1f);
			ImGui::DragFloat("roughness", &m_World.materials[sphere.m_MaterialID].roughness, 0.01f, 0.0f, 1.0f);
			ImGui::DragFloat("metallic", &m_World.materials[sphere.m_MaterialID].metallic, 0.01f, 0.0f, 1.0f);
